...
public class DOM_Blocks implements ModInitializer {
    ...
    public static final  Block GOLD_STAIR = new NewStairBlock(Blocks.GOLD_BLOCK.getDefaultState(), AbstractBlock.Settings.copy(Blocks.GOLD_BLOCK));

    public static final  Block IRON_STAIR = new NewStairBlock(Blocks.IRON_BLOCK.getDefaultState(), AbstractBlock.Settings.copy(Blocks.IRON_BLOCK));
