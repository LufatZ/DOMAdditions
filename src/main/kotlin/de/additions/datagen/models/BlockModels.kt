...
object BlockModels {
     ...
     */
    fun BlockStateModelGenerator?.generateStairModels() {
        registeredStairs.forEachIndexed { index, stair ->
            val parentBlock = blockVariantsParents[index]
     ...
     */
    fun BlockStateModelGenerator?.generateSlabModels() {
     ...
     */
    fun BlockStateModelGenerator?.generateLanternModels() {
        registeredLanterns.forEachIndexed { index, lantern ->
            val parentBlock = lanternVariantsParents[index]
     ...
     */
    fun BlockStateModelGenerator?.generateTrapdoorModels() {
        registeredTrapdoors.forEachIndexed { index, trapdoor ->
            val parentBlock = trapdoorVariantsParents[index]
